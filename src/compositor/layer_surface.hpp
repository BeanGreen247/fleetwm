...
class LayerSurface {
 public:
  ...
  // wlroots rejects wlr_layer_surface_v1_configure() until the surface
  // has received its first commit (see layer_surface_surface_commit) --
  // this guards the initial configure to fire exactly once, there.
